...
module.exports = exports = {
  ...
  THREADS: {
    MSG_TYPE: {
      ActionRequest: Symbol('ActionRequest'),
      ActionResponse: Symbol('ActionResponse'),
      Notification: Symbol('Notification')
    },
    kFIRST_NOTIF: Symbol('kFIRST_NOTIF')
  },
  GAME_HANDLE: {
    ACTIONS: {
      GetStatus: Symbol('GetStatus'),
      ReservePlayer: Symbol('ReservePlayer'),
      AddPlayer: Symbol('AddPlayer'),
      RemovePlayer: Symbol('RemovePlayer'),
      ClearPlayers: Symbol('ClearPlayers')
    }
  }
}
