...
import TimedStore from './timed-store.js'
...
const debug = debugFactory('colonialwars:cwserver')

/**
 * CWServer class.
 */
export default class CWServer {
  /**
  ...
  _initApp () {
    ...
    this.router.get('/game-auth/get', this.controllers.gameAuth(this.manager))
